...
const RESPONSE_TEXT = {
  ...
  'type-city': { title: '대도시형', desc: '차상위·한부모 집단만 유독 저조해요. 이 집단은 시설 밀도와 통계적으로 무관해서(상관 약 −0.09, 2026-08 수집 데이터 기준), 시설 확충보다 학교·지역아동센터 연계, 신청 창구 접근성 개선 등 인지도 개선에 우선 배분하는 게 효과적일 수 있어요.' },
  'type-rural': { title: '농어촌형', desc: '대상 인원 자체가 적은 편이에요(군 단위 평균 약 690명, 2026-08 수집 데이터 기준). 기초생활수급 집단은 시설 밀도와 관련 있어서(상관 약 0.50, 2026-08 수집 데이터 기준), 비율(%)보다 실인원 기준으로 관리하고 개별 접촉을 시도하는 게 유효할 수 있어요.' },
